  ...
  return (
    <main className="px-8 md:px-20 lg:px-40">
      ...
      >
        ...
        <h1 className="text-3xl md:text-5xl font-medium text-sky-500 mt-4 font-sans">
          GBEMISOLA MAJEKODUNMI
        </h1>
        <h3 className="text-xl md:text-2xl font-mono mt-2">
          Frontend Engineer (Learner)
        </h3>
      ...
      <section id="license" className="mt-20">
        ...
        <p className="mt-1 text-md text-center">
